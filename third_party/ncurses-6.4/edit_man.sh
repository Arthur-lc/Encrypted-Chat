...
TERMINFO="/home/arthur/Projects/T-Chat/build/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f "/home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man_alias.sed" ; then
cat >>/home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man_alias.sed"
	fi
	...
	aliases=`sed -f "$top_srcdir/man/manlinks.sed" "$inalias" |sed -f "/home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man_alias.sed" | sort -u; test "$inalias" = "$nCurses" && echo curses`
	cf_target=`grep "^$cf_source" /home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f "/home/arthur/Projects/T-Chat/third_party/ncurses-6.4/man_alias.sed" \
		< "$i" | sed -f /home/arthur/Projects/T-Chat/third_party/ncurses-6.4/edit_man.sed >$TMP
